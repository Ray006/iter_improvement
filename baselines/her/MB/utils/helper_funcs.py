...
# import baselines.her.MB.envs
# from baselines.her.MB.envs.gym_env import GymEnv
# from baselines.her.MB.envs.mb_env import MBEnvWrapper
...
def check_dims(dataset_trainRand):

    ### assign dims
    acSize = dataset_trainRand.dataY.shape[2]
    ...
    print("dataZ dims: ", dataset_trainRand.dataZ.shape,
          "\n######################\n")
    # num_data = dataset_trainRand.dataX.shape
...
def collect_random_rollouts(env,
    ...
    if params.use_threading:
        from baselines.her.MB.samplers.collect_samples_threaded import CollectSamples
    else:
        from baselines.her.MB.samplers.collect_samples import CollectSamples
